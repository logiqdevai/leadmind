...
import { CampaignIntegrationsBrowseController } from './campaign-integrations-browse.controller';
...
@Module({
  ...
  controllers: [
    CampaignIntegrationsController,
    CampaignIntegrationsBrowseController,
  ],
