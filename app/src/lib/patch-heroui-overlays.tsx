...
import { Autocomplete, ComboBox, DatePicker, DateRangePicker, Dropdown, Modal, Popover, Select } from '@heroui/react';
...
function withNonModal<T>(Component: T): T {
	...
	Object.assign(Wrapped, {
		displayName: (Component as { displayName?: string }).displayName ?? (Component as { name?: string }).name,
	});
	return Wrapped as T;
}
